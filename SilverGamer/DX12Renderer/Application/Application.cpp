...
D3D12_CPU_DESCRIPTOR_HANDLE IApplication::DepthStencilView()
{
	return mDsvHeap->GetCPUDescriptorHandleForHeapStart();
}

D3D12_CPU_DESCRIPTOR_HANDLE IApplication::CurrentBackBufferView()
{
...
ID3D12Resource* IApplication::CurrentBackBuffer()
{
